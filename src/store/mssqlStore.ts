/**
 * Microsoft SQL Server Store Implementation (Stub)
 */
...
export class MSSQLStore implements FhirStore {
  constructor() {
    console.log('Microsoft SQL Server store initialized (stub implementation)');
  }

  async getSchedules(query: FhirScheduleQuery): Promise<Schedule[]> {
    throw new Error('MSSQL store not yet implemented');
  }
