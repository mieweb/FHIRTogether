...
| Before | After |
|--------|-------|
| ![Provider view before duplicate-card fix](packages/fhir-scheduler/docs/screenshots/provider-appointments-before.png) | ![Provider view after duplicate-card fix](packages/fhir-scheduler/docs/screenshots/provider-appointments-after.png) |
